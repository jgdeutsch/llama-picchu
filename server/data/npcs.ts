...
export const npcTemplates: NpcTemplate[] = [
  ...
  },
  {
    ...
    type: 'shopkeeper',
    level: 5,
    stats: { str: 10, dex: 8, con: 14, int: 10, wis: 14, cha: 12 },
    maxHp: 40,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Marge gestures at her vegetables* Fresh today! Well, fresh-ish. Best you\'ll find since Wilson took the good farmland.',
      farewell: 'Come back tomorrow - I might have carrots!',
      keywords: {
        vegetables: 'Turnips, potatoes, some sad-looking greens. It\'s what grows in shade, since the sunny fields belong to the castle now.',
        wilson: '*She spits* Don\'t get me started. My family used to have a farm. Now we sell what others grow.',
        prices: 'High, I know. Blame the taxes. I barely keep enough to feed my own.',
      },
    },
    respawnSeconds: 0,
  ...
  },
  {
    ...
    type: 'ambient',
    level: 3,
    stats: { str: 4, dex: 4, con: 8, int: 16, wis: 18, cha: 14 },
    maxHp: 20,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Gertrude peers at you* New face. I\'ll remember it. I remember everything, you know.',
      farewell: '*She waves a gnarled hand* Go on then. I\'ll be watching.',
      keywords: {
        gossip: '*She cackles* What do you want to know? I\'ve heard things about everyone. The question is - what will you trade for it?',
        wilson: '*She lowers her voice* His cook spits in his soup. Don\'t tell anyone I told you.',
        resistance: '*She looks around carefully* I don\'t know nothing about that. *She winks* Nothing at all.',
      },
    },
    respawnSeconds: 0,
  ...
  },
  {
    ...
    type: 'ambient',
    level: 2,
    stats: { str: 8, dex: 10, con: 10, int: 8, wis: 6, cha: 12 },
    maxHp: 25,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Pip looks up, flour on his nose* Oh! A customer! I mean - welcome! Possum will be right with you!',
      farewell: '*He waves, getting flour everywhere* Come back soon! Try the cinnamon rolls!',
      keywords: {
        bread: 'I\'m learning to make the twisted loaves! It\'s harder than it looks. Mine keep coming out... lumpy.',
        possum: 'He\'s the best baker in Gamehenge! Maybe all of anywhere! He says I\'ll be good someday. If I stop burning things.',
        work: 'It\'s hard but I love it. The smell, you know? Nothing smells better than fresh bread.',
      },
    },
    respawnSeconds: 0,
  ...
  },
  {
    ...
    type: 'shopkeeper',
    level: 10,
    stats: { str: 6, dex: 18, con: 8, int: 14, wis: 14, cha: 10 },
    maxHp: 35,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Lydia looks you up and down* Those clothes have seen better days. I can help - if you can pay.',
      farewell: '*She\'s already back at her sewing* Come back when you need something that fits properly.',
      keywords: {
        clothes: 'I make work clothes, traveling clothes, and... specialty items. Depends what you need.',
        disguise: '*She raises an eyebrow* That\'s a strong word. I make practical garments for practical purposes. Some purposes are more practical than others.',
        prices: 'Quality costs. But my clothes last five times longer than market trash. That\'s economy.',
      },
    },
    shopInventory: [
  ...
  },
  {
    ...
    type: 'shopkeeper',
    level: 8,
    stats: { str: 8, dex: 10, con: 10, int: 16, wis: 14, cha: 16 },
    maxHp: 45,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Stumpy grins* Welcome, welcome! Whatever you need, I\'ve got it. Somewhere. Let me just... *he rummages*',
      farewell: '*He counts your coins again* Pleasure doing business. Tell your friends - Stumpy\'s got the goods!',
      keywords: {
        buy: 'Everything\'s for sale! Tools, supplies, curiosities. Name it and I\'ll quote you a price. Then we\'ll negotiate.',
        haggle: '*He rubs his hands* Now you\'re speaking my language! Let\'s dance.',
        leg: '*He taps the wooden leg* Thresher got it. Best thing that ever happened to me - farming\'s hard work. This? This is just talking and counting.',
      },
    },
    shopInventory: [
      { itemTemplateId: 80, stock: -1, buyPriceMultiplier: 1.0, sellPriceMultiplier: 0.5 },
      { itemTemplateId: 81, stock: -1, buyPriceMultiplier: 1.0, sellPriceMultiplier: 0.5 },
  ...
  },
  {
    ...
    type: 'ambient',
    level: 1,
    stats: { str: 4, dex: 14, con: 8, int: 8, wis: 4, cha: 14 },
    maxHp: 15,
    maxMana: 0,
    behavior: 'wander',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*The children pause their game* Are you a hero? You look like you could be a hero!',
      farewell: '*They\'re already running off* Bye! Don\'t get caught by Wilson!',
      keywords: {
        play: 'We\'re playing Revolution! Timi is Wilson and we have to catch him! *giggles*',
        hero: 'My da says the heroes are all gone. But I don\'t believe him. Are YOU a hero?',
        wilson: '*They go quiet* We\'re not supposed to talk about him. *whispers* He\'s scary.',
      },
    },
    respawnSeconds: 0,
  ...
  },
  {
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*Brom nods wearily* Afternoon. Taking a break before the second shift.',
      farewell: '*He stretches his back* Back to it. The crops don\'t harvest themselves.',
      keywords: {
        work: 'Fields, mostly. Whatever needs doing. Used to be our farm, now we work it for Wilson\'s share. Which is most of it.',
        tired: '*He laughs bitterly* Always. But what choice is there? Work or starve.',
        help: 'You looking for work? There\'s always more to do than hands to do it. Doesn\'t pay much, but it\'s honest.',
      },
    },
    respawnSeconds: 0,
  ...
  },
  {
    ...
    type: 'ambient',
    level: 5,
    stats: { str: 4, dex: 12, con: 8, int: 12, wis: 18, cha: 10 },
    maxHp: 25,
    maxMana: 0,
    behavior: 'stationary',
    aggroRange: 0,
    ...
    experienceValue: 0,
    dialogue: {
      greeting: '*He barely looks up from his whittling* Mmm? Oh. Hello. Don\'t mind me.',
      farewell: '*He waves vaguely with his knife* Mm-hmm. Take care now.',
      keywords: {
        whittling: '*He holds up a half-finished bird* Keeps the hands busy. Keeps the mind quiet. You want one when I\'m done?',
        past: '*He sighs* I\'ve seen three tyrants come and go. Wilson\'s the worst, but he\'ll pass too. They all do.',
        advice: '*He stops whittling* Keep your head down. Help your neighbors. Don\'t draw attention. That\'s how you survive.',
      },
    },
    respawnSeconds: 0,
...
export function getNpcPersonalityPrompt(npcId: number): string {
  const personalities: Record<number, string> = {
    ...
    123: 'Loud, opinionated, practical, knows everyone\'s business. Calls out prices, complains about taxes, secretly kind to those in need. Mood: Busy, vocal.',
    124: 'Sharp-eyed, gossipy, trades in secrets, remembers everything. Speaks in knowing tones, hints rather than tells, loves intrigue. Mood: Watchful, sly.',
    125: 'Eager, clumsy, enthusiastic, wants to impress. Talks fast, gets flustered, genuinely sweet, covered in flour. Mood: Excited, nervous.',
    126: 'Precise, observant, secretly helps resistance, professional. Measured speech, assesses everyone, loyal to her people. Mood: Focused, guarded.',
    127: 'Haggler, cheerful, shrewd, loves the deal. Always negotiating, friendly but calculating, knows value of everything. Mood: Energetic, opportunistic.',
    128: 'Innocent, playful, curious, unaware of darkness. Speak like children, ask awkward questions, full of hope. Mood: Joyful, carefree.',
    129: 'Tired, resigned, honest, quietly resentful. Speaks simply, doesn\'t complain much, works hard, dreams small. Mood: Weary, stoic.',
    130: 'Ancient, cryptic, peaceful, seen it all. Speaks slowly, offers unexpected wisdom, mostly wants quiet. Mood: Serene, distant.',
  };
